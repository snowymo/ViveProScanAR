            ...
            foreach (DualCameraIndex camIndex in Enum.GetValues(typeof(DualCameraIndex)))
            {
                ...
                if (trackedCamera != null)
                {
                    ...
                    trackedCamera.Anchor.transform.localPosition = new Vector3(0,
                        -ViveSR_DualCameraImageCapature.OffsetHeadToCamera[camValue * 3 + 1],
                        -ViveSR_DualCameraImageCapature.OffsetHeadToCamera[camValue * 3 + 2]);
                    ...
                    for (int planeIndex = 0; planeIndex < 2; planeIndex++)
                    {
                        ...
                        if (imagePlane != null)
                        {
                            imagePlane.DistortedImageWidth = ViveSR_DualCameraImageCapature.DistortedImageWidth;
                            imagePlane.DistortedImageHeight = ViveSR_DualCameraImageCapature.DistortedImageHeight;
                            imagePlane.UndistortedImageWidth = ViveSR_DualCameraImageCapature.UndistortedImageWidth;
                            imagePlane.UndistortedImageHeight = ViveSR_DualCameraImageCapature.UndistortedImageHeight;
                            if (camIndex == DualCameraIndex.LEFT)
                            {
                                imagePlane.DistortedCx = ViveSR_DualCameraImageCapature.DistortedCx_L;
                                imagePlane.DistortedCy = ViveSR_DualCameraImageCapature.DistortedCy_L;
                                imagePlane.UndistortedCx = ViveSR_DualCameraImageCapature.UndistortedCx_L;
                                imagePlane.UndistortedCy = ViveSR_DualCameraImageCapature.UndistortedCy_L;
                                imagePlane.FocalLength = ViveSR_DualCameraImageCapature.FocalLength_L;
                                imagePlane.UndistortionMap = ViveSR_DualCameraImageCapature.UndistortionMap_L;
                            }
                            else if (camIndex == DualCameraIndex.RIGHT)
                            {
                                imagePlane.DistortedCx = ViveSR_DualCameraImageCapature.DistortedCx_R;
                                imagePlane.DistortedCy = ViveSR_DualCameraImageCapature.DistortedCy_R;
                                imagePlane.UndistortedCx = ViveSR_DualCameraImageCapature.UndistortedCx_R;
                                imagePlane.UndistortedCy = ViveSR_DualCameraImageCapature.UndistortedCy_R;
                                imagePlane.FocalLength = ViveSR_DualCameraImageCapature.FocalLength_R;
                                imagePlane.UndistortionMap = ViveSR_DualCameraImageCapature.UndistortionMap_R;
                            }
                        }
                    }
                }
